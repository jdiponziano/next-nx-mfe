    ...
    callback({
      responseHeaders: {
        ...
        'Content-Security-Policy': [
          electronIsDev
            ? `default-src ${customScheme}://* 'unsafe-inline' devtools://* 'unsafe-eval' data: https://static.cimcontent.net http://localhost:4200 http://localhost:4201 script-src-elem`
            : `default-src ${customScheme}://* 'unsafe-inline' data: https://static.cimcontent.net http://localhost:4200 http://localhost:4201 script-src-elem`
        ]
      }
    });
  });
